 ...
 */
 ...
 NS_LOG_COMPONENT_DEFINE_EXAMPLE_WITH_UTILITIES("EloraExample-two-channels");
 ...
 main(int argc, char* argv[])
 {
     ...
     if(NS_select == 0){
         ...
         apiPort = 1885;
         token = "NNSXS.KRJHNPAMZEOFXBSDVLRIL5DQBTSWFDEEOAZDQPA.KWKWUNLJUUZPK5AQ6N2TGWSB2YGR5ULZNCQIOMNXMP7NO6Y5VNPQ";
...
/*      positionAllocator = CreateObject<RandomRectanglePositionAllocator>();
     ...
     allocator->Add(Vector(200, 0, 0));
     mobilityEd.SetPositionAllocator(allocator);
     mobilityEd.SetMobilityModel("ns3::ConstantPositionMobilityModel");
